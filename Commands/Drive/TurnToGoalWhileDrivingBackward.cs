...
{
    public class TurnToGoalWhileDrivingBackward : Command
    {
        public const double shotZone = .05;

        public TurnToGoalWhileDrivingBackward()
        {
        ...
        {
            ChopShop2016.drive.turnToGoalWhileDrivingBackward(ChopShop2016.vision.XOffset);
        }
